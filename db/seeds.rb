...
authors = User.create([
  ...
  {name: 'Sakura', photo: 'https://cdn.myanimelist.net/images/characters/15/103640.jpg'}
  ])
...
comments = Comment.create([
  ...
  {author_id: 4, post_id: 1, text: 'Sorry I\'m Late Guys, I Got Lost On The Path Of Life.'},
  {author_id: 5, post_id: 1, text: 'Run Into The Setting Sun. Run And Suffer. But Don\'t Mess Up Your Hair!'},
  {author_id: 2, post_id: 2, text: 'What Adult Goes Full Force While Fighting Mere Children?'},
  {author_id: 3, post_id: 2, text: 'I Am Not A Pervert, I Am A Super Pervert!'}
])
